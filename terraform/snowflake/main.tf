...
#######################################
module "snowflake" {
#  source = "git@github.com:smorcom23/Databridge-customer-onboarding//terraform/modules/snowflake_latest?ref=latest"
  source = "github.com/arisglobal/sharedactions//terraform/modules/snowflake_latest?ref=latest"
