...
CREATE OR REPLACE PROCEDURE $$TGT_DB_NAME.$$LSDB_TRANSFM.PRC_LS_DB_SAFETY_LATENESS_ASSESSMENT()
...
SELECT (select nvl(max(row_wid)+1,1) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL where target_table_name='LS_DB_SAFETY_LATENESS_ASSESSMENT'),
	'LSRA','Case','LS_DB_SAFETY_LATENESS_ASSESSMENT',null,:CURRENT_TS_VAR,null,null,null,null,null,'In Progress',null;


UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG
SET PARAM_VALUE= nvl((SELECT LOAD_START_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL WHERE TARGET_TABLE_NAME='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND LOAD_STATUS = 'Completed' ORDER BY ROW_WID DESC limit 1),to_timestamp('1900-01-01','YYYY-MM-DD'))
...
DROP TABLE IF EXISTS $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP;
CREATE TEMPORARY TABLE  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  As select RECORD_ID,'lsmv_late_case_activity_info' AS TABLE_NAME FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_late_case_activity_info WHERE CDC_OPERATION_TYPE IN ('D') UNION ALL select RECORD_ID,'lsmv_lateness_info_inbound' AS TABLE_NAME FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_info_inbound WHERE CDC_OPERATION_TYPE IN ('D') UNION ALL select RECORD_ID,'lsmv_lateness_sub_compliance' AS TABLE_NAME FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_sub_compliance WHERE CDC_OPERATION_TYPE IN ('D') ;
DROP TABLE IF EXISTS $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP;
CREATE TEMPORARY TABLE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP  AS WITH CD_WITH AS (select CD_ID,CD,DE,LN from 
(
...
,row_number() over(partition by LSMV_CODELIST_NAME.CODELIST_ID,LSMV_CODELIST_CODE.CODE,LSMV_CODELIST_DECODE.LANGUAGE_CODE 
                   order by LSMV_CODELIST_NAME.CDC_OPERATION_TIME  DESC,LSMV_CODELIST_CODE.CDC_OPERATION_TIME DESC,LSMV_CODELIST_DECODE.CDC_OPERATION_TIME DESC) rank
                                                                                      ...
                                                                                      (
                                                                                                     ...
                                                                                                     FROM $$STG_DB_NAME.$$LSDB_RPL.LSMV_CODELIST_NAME WHERE CODELIST_ID IN ('1002','1002','1002','10100','10144','10144','801','801','9662')
...
select DISTINCT RECORD_ID record_id, im_rec_id common_parent_key   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_sub_compliance WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT im_rec_id record_id, im_rec_id common_parent_key  FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_sub_compliance WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT RECORD_ID record_id, im_rec_id common_parent_key   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_late_case_activity_info WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT im_rec_id record_id, im_rec_id common_parent_key  FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_late_case_activity_info WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT RECORD_ID record_id, im_rec_id common_parent_key   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_info_inbound WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT im_rec_id record_id, im_rec_id common_parent_key  FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_info_inbound WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_SAFETY_LATENESS_ASSESSMENT' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
)
...
FROM 
$$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_info_inbound
 WHERE ( RECORD_ID IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET) OR
im_rec_id IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET))
 AND RECORD_ID not in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_lateness_info_inbound')
  ) where REC_RANK=1 )
...
FROM 
$$STG_DB_NAME.$$LSDB_RPL.lsmv_late_case_activity_info
 WHERE ( RECORD_ID IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET) OR
im_rec_id IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET))
 AND RECORD_ID not in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_late_case_activity_info')
  ) where REC_RANK=1 )
...
FROM 
$$STG_DB_NAME.$$LSDB_RPL.lsmv_lateness_sub_compliance
 WHERE ( RECORD_ID IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET) OR
im_rec_id IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET))
 AND RECORD_ID not in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_lateness_sub_compliance')
  ) where REC_RANK=1 )
...
SET REC_READ_CNT = (select count(LOAD_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP)
where target_table_name='LS_DB_SAFETY_LATENESS_ASSESSMENT'
and LOAD_STATUS = 'In Progress'
and LOAD_START_TS=(select max(LOAD_START_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL where target_table_name='LS_DB_SAFETY_LATENESS_ASSESSMENT'
					and LOAD_STATUS = 'In Progress') 
; 

UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT   
...
FROM 	$$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP 
...
FROM 	$$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT left join $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP 
...
and LS_DB_SAFETY_LATENESS_ASSESSMENT.latesubcomp_RECORD_ID in (select latesubcomp_RECORD_ID from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP )
...
DELETE FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT TGT 
...
INSERT INTO $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT
( 
processing_dt ,
user_modified ,
date_modified ,
...
latecaseact_capa_number,
latecaseact_capa_auto_generated
FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP TMP where not exists (select 1 from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT TGT
...
AND LS_DB_SAFETY_LATENESS_ASSESSMENT.INTEGRATION_ID = LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP.INTEGRATION_ID
AND nvl(LS_DB_SAFETY_LATENESS_ASSESSMENT.latesubcomp_RECORD_ID,-1) = nvl(LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP.latesubcomp_RECORD_ID,-1)
AND LS_DB_SAFETY_LATENESS_ASSESSMENT.EXPIRY_DATE = TO_DATE('9999-31-12','YYYY-DD-MM')
AND MD5(NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT.lateinfoinbo_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')) ||'-'||NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT.latecaseact_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')) ||'-'||NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT.latesubcomp_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')) ) <> MD5(NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP.lateinfoinbo_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM'))||'-'||NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP.latecaseact_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM'))||'-'||NVL(LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP.latesubcomp_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')))
AND 'YES'=(SELECT CHAR_PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='HISTORY_CONTROL' AND PARAM_NAME='KEEP_HISTORY')	
;
...
DELETE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT TGT
WHERE  ( latecaseact_record_id  in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_late_case_activity_info') OR lateinfoinbo_record_id  in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_lateness_info_inbound') OR latesubcomp_record_id  in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_SAFETY_LATENESS_ASSESSMENT_DELETION_TMP  WHERE TABLE_NAME='lsmv_lateness_sub_compliance')
)
--AND 'I' = (SELECT PARAM_NAME FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LOAD_CONTROL')
AND 'NO'=(SELECT CHAR_PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='HISTORY_CONTROL' AND PARAM_NAME='KEEP_HISTORY');


UPDATE  $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT TGT
...
REC_PROCESSED_CNT=(select count(LOAD_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT where LOAD_TS= (select LOAD_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP limit 1)),
LOAD_TS=(select LOAD_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_SAFETY_LATENESS_ASSESSMENT_TMP limit 1),
...
UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL set ERROR_DETAILS=:line, LOAD_STATUS = 'Error' WHERE target_table_name='LS_DB_SAFETY_LATENESS_ASSESSMENT'
and LOAD_STATUS = 'In Progress'
;
