...
CREATE OR REPLACE PROCEDURE $$TGT_DB_NAME.$$LSDB_TRANSFM.PRC_LS_DB_AE_SENDER_RECEIVER()
...
SELECT (select nvl(max(row_wid)+1,1) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL where target_table_name='LS_DB_AE_SENDER_RECEIVER'),
	'LSRA','Case','LS_DB_AE_SENDER_RECEIVER',null,:CURRENT_TS_VAR,null,null,null,null,null,'In Progress',null;


UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG
SET PARAM_VALUE= nvl((SELECT LOAD_START_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL WHERE TARGET_TABLE_NAME='LS_DB_AE_SENDER_RECEIVER' AND LOAD_STATUS = 'Completed' ORDER BY ROW_WID DESC limit 1),to_timestamp('1900-01-01','YYYY-MM-DD'))
...
DROP TABLE IF EXISTS $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP;
CREATE TEMPORARY TABLE  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP  As select RECORD_ID,'lsmv_e2b_ae_case_receiver' AS TABLE_NAME FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_receiver WHERE CDC_OPERATION_TYPE IN ('D') UNION ALL select RECORD_ID,'lsmv_e2b_ae_case_sender' AS TABLE_NAME FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_sender WHERE CDC_OPERATION_TYPE IN ('D') ;
DROP TABLE IF EXISTS $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP;
CREATE TEMPORARY TABLE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP  AS WITH CD_WITH AS (select CD_ID,CD,DE,LN from 
(
...
,row_number() over(partition by LSMV_CODELIST_NAME.CODELIST_ID,LSMV_CODELIST_CODE.CODE,LSMV_CODELIST_DECODE.LANGUAGE_CODE 
                   order by LSMV_CODELIST_NAME.CDC_OPERATION_TIME  DESC,LSMV_CODELIST_CODE.CDC_OPERATION_TIME DESC,LSMV_CODELIST_DECODE.CDC_OPERATION_TIME DESC) rank
                                                                                      ...
                                                                                      (
                                                                                                     ...
                                                                                                     FROM $$STG_DB_NAME.$$LSDB_RPL.LSMV_CODELIST_NAME WHERE CODELIST_ID IN ('5014')
...
select DISTINCT RECORD_ID record_id, 0 common_parent_key,  ARI_REC_ID ARI_REC_ID   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_sender WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT 0 record_id, 0 common_parent_key,  ARI_REC_ID ARI_REC_ID   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_sender WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT RECORD_ID record_id, 0 common_parent_key,  ARI_REC_ID ARI_REC_ID   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_receiver WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
UNION 

select DISTINCT 0 record_id, 0 common_parent_key,  ARI_REC_ID ARI_REC_ID   FROM $$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_receiver WHERE CDC_OPERATION_TIME >(SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_LB')
	AND CDC_OPERATION_TIME<= (SELECT PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LS_DB_AE_SENDER_RECEIVER' AND PARAM_NAME='CDC_EXTRACT_TS_UB')
)
 ,
...
FROM 
$$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_receiver
 WHERE  RECORD_ID IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET) 
 AND RECORD_ID not in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP  WHERE TABLE_NAME='lsmv_e2b_ae_case_receiver')
  ) where REC_RANK=1 )
...
FROM 
$$STG_DB_NAME.$$LSDB_RPL.lsmv_e2b_ae_case_sender
 WHERE  RECORD_ID IN (SELECT record_id FROM LSMV_CASE_NO_SUBSET) 
 AND RECORD_ID not in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP  WHERE TABLE_NAME='lsmv_e2b_ae_case_sender')
  ) where REC_RANK=1 )
...
SET REC_READ_CNT = (select count(LOAD_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP)
where target_table_name='LS_DB_AE_SENDER_RECEIVER'
and LOAD_STATUS = 'In Progress'
and LOAD_START_TS=(select max(LOAD_START_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL where target_table_name='LS_DB_AE_SENDER_RECEIVER'
					and LOAD_STATUS = 'In Progress') 
; 

UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER   
...
FROM 	$$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP 
...
FROM 	$$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER left join $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP 
...
and LS_DB_AE_SENDER_RECEIVER.e2baecasesndr_RECORD_ID in (select e2baecasesndr_RECORD_ID from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP )
...
DELETE FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER TGT 
...
INSERT INTO $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER
( receipt_id    ,
case_no       ,
case_version  ,
processing_dt ,
...
e2baecaserecv_city,
e2baecaserecv_ari_rec_id
FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP TMP where not exists (select 1 from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER TGT
...
DELETE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER TGT
WHERE  ( e2baecaserecv_record_id  in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP  WHERE TABLE_NAME='lsmv_e2b_ae_case_receiver') OR e2baecasesndr_record_id  in (SELECT RECORD_ID FROM  $$TGT_DB_NAME.$$LSDB_TRANSFM.LSMV_AE_SENDER_RECEIVER_DELETION_TMP  WHERE TABLE_NAME='lsmv_e2b_ae_case_sender')
)
--AND 'I' = (SELECT PARAM_NAME FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='LOAD_CONTROL')
AND 'NO'=(SELECT CHAR_PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='HISTORY_CONTROL' AND PARAM_NAME='KEEP_HISTORY');
...
AND LS_DB_AE_SENDER_RECEIVER.INTEGRATION_ID = LS_DB_AE_SENDER_RECEIVER_TMP.INTEGRATION_ID
AND nvl(LS_DB_AE_SENDER_RECEIVER.e2baecasesndr_RECORD_ID,-1) = nvl(LS_DB_AE_SENDER_RECEIVER_TMP.e2baecasesndr_RECORD_ID,-1)
AND LS_DB_AE_SENDER_RECEIVER.EXPIRY_DATE = TO_DATE('9999-31-12','YYYY-DD-MM')
AND MD5(NVL(LS_DB_AE_SENDER_RECEIVER.e2baecaserecv_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')) ||'-'||NVL(LS_DB_AE_SENDER_RECEIVER.e2baecasesndr_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')) ) <> MD5(NVL(LS_DB_AE_SENDER_RECEIVER_TMP.e2baecaserecv_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM'))||'-'||NVL(LS_DB_AE_SENDER_RECEIVER_TMP.e2baecasesndr_DATE_MODIFIED ,TO_DATE('1900-01-01','YYYY-DD-MM')))
AND 'YES'=(SELECT CHAR_PARAM_VALUE FROM $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_ETL_CONFIG WHERE TARGET_TABLE_NAME ='HISTORY_CONTROL' AND PARAM_NAME='KEEP_HISTORY')	
;
...
UPDATE  $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER TGT
...
REC_PROCESSED_CNT=(select count(LOAD_TS) from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER where LOAD_TS= (select LOAD_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP limit 1)),
LOAD_TS=(select LOAD_TS from $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_AE_SENDER_RECEIVER_TMP limit 1),
...
UPDATE $$TGT_DB_NAME.$$LSDB_TRANSFM.LS_DB_DATA_PROCESSING_DTL_TBL set ERROR_DETAILS=:line, LOAD_STATUS = 'Error' WHERE target_table_name='LS_DB_AE_SENDER_RECEIVER'
and LOAD_STATUS = 'In Progress'
;
